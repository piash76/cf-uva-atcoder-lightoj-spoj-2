...
int main()
{
   ...
   for(i=0;i<b.size();i++)
    ...
    ///matching colored pairs of a and b
    for(char i='a';i<='z';i++)
    {
        int idx=i-'a'+1;
        while(c1[idx]>=1 and c2[idx]>=1)
        {
            c1[idx]--;
            c2[idx]--;
            int id=q1[idx].front();
    ...
    ///matching colored pair of a and ? of b
    for(char i='a';i<='z';i++)
    {
        int idx=i-'a'+1;
        while(c1[idx]>=1 and c2[28]>=1)
        {
            c1[idx]--;
            c2[28]--;
            int id=q1[idx].front();
