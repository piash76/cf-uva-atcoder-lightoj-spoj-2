...
///FINDING the max cost to go to the farthest node from each node(kono node theke maximum furthest node e jeye maximum cost)
///find two nodes in the tree whose distance is maximum amongst all nodes.
