           ...
           for(k=1;k<=n;k++)
            {
               ...
               // cout<<"K "<<k<<endl;
                ...
                x3=ar[k].ff;
                y3=ar[k].ss;
                if(x1*(y2-y3)+x2*(y3-y1)+x3*(y1-y2)==0) {f=true;break;}

               // cout<<x1<<" "<<y1<<"\n"<<x2<<" "<<y2<<"\n"<<x3<<" "<<y3<<endl;
               // if(x2-x1!=0)  d1=(double)(y2-y1)*(1.0)/(double)(x2-x1)*(1.0);
               // if(x3-x1!=0)  d2=(double)(y3-y1)*(1.0)/(double)(x3-x1)*(1.0);
               // if(d1==d2) {f=true;break;}
            }
            if(f) {break;}
        }
        if(f) {break;}
