...
int main()
{
    ...
    for(i=1;i<=n;i++)
    {
     ...
     //cout<<"IDX "<<4<<" FIND IDX "<<fnd(4)<<" SUM{FND{IDX}} "<<sum[fnd(4)]<<endl;
    ...
    for(i=n;i>=1;i--)
    {
        ...
        //if(idx-1>=1) cout<<"IDX "<<idx<<" par[idx] "<<par[idx]<<" IDX-1 "<<idx-1<<" par[idx-1] "<<par[idx-1]<<endl;
      //  if(idx+1<=n) cout<<"IDX "<<idx<<" par[idx] "<<par[idx]<<" IDX+1 "<<idx+1<<" par[idx+1] "<<par[idx+1]<<endl;

        //cout<<"BEFORE "<<endl;


        if(idx-1>=1 and vis[idx-1])
        {
            //cy;
            tie(idx-1,idx);
           // cout<<"IDX "<<idx<<" par[idx] "<<par[idx]<<" IDX-1 "<<idx-1<<" par[idx-1] "<<par[idx-1]<<endl;
        }
        ...
        //if(vis[idx-1]) cout<<"IDX "<<idx<<" par[idx] "<<par[idx]<<" IDX-1 "<<idx-1<<" par[idx-1] "<<par[idx-1]<<endl;
     ...
     //   cout<<"IDX "<<idx<<" FIND IDX "<<fnd(idx)<<" SUM{FND{IDX}} "<<sum[fnd(idx)]<<endl;
